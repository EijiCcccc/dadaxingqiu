...
```bash
INIT=$(node "/Users/douyu/src/flutter_project/spacecraft/.cursor/get-shit-done/bin/gsd-tools.cjs" state load)
if [[ "$INIT" == @file:* ]]; then INIT=$(cat "${INIT#@file:}"); fi
```

Extract `commit_docs` from init JSON. Resolve debugger model:
```bash
debugger_model=$(node "/Users/douyu/src/flutter_project/spacecraft/.cursor/get-shit-done/bin/gsd-tools.cjs" resolve-model gsd-debugger --raw)
```
