...
export default function LightFeedback() {
      ...
      <div className="px-6 py-6">
        ...
        <div className="mb-6">
          ...
          <textarea
            ...
            className="w-full h-40 bg-white border border-gray-200 rounded-2xl px-4 py-3 text-gray-900 placeholder:text-gray-400 text-base resize-none focus:outline-none focus:border-purple-500 focus:ring-2 focus:ring-purple-500/20 shadow-sm"
          />
          <div className="text-right mt-2">
            <span
              className={`text-sm ${
                feedback.length > 500 ? "text-red-500" : "text-gray-500"
              }`}
            >
              {feedback.length}/500
            </span>
        ...
        <div className="mb-8">
          ...
          <input
            ...
            className="w-full h-14 bg-white border border-gray-200 rounded-2xl px-4 text-gray-900 placeholder:text-gray-400 text-base focus:outline-none focus:border-purple-500 focus:ring-2 focus:ring-purple-500/20 shadow-sm"
          />
        </div>
        ...
        <div className="mt-6 bg-purple-50 border border-purple-100 rounded-2xl p-4">
          <h3 className="text-gray-900 text-sm font-medium mb-2">温馨提示</h3>
