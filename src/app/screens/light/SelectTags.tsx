...
export default function LightSelectTags() {
    ...
    <div className="min-h-screen bg-gradient-to-b from-purple-100 via-pink-50/30 to-white max-w-md mx-auto pb-24">
      ...
      <div className="sticky top-0 z-10 bg-purple-100/80 backdrop-blur-lg border-b border-purple-200/50">
        <div className="flex items-center justify-center h-16 px-4 relative">
          ...
          <h1 className="text-lg font-semibold text-purple-900">请选择个人标签</h1>
        </div>
      </div>
      ...
      <div className="px-6 py-8">
        ...
        <div className="space-y-8">
          {tagGroups.map((group, groupIndex) => (
            <div key={groupIndex}>
              <h2 className="text-purple-900 text-base font-medium mb-4">
                {group.title}
              </h2>
        ...
        {/* Bottom Button */}
        <div className="fixed bottom-0 left-0 right-0 max-w-md mx-auto bg-gradient-to-t from-white via-purple-50/50 to-transparent p-6 pt-8">
          <Button
            onClick={handleEnter}
