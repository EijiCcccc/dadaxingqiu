    ...
    <div className="min-h-screen bg-gradient-to-b from-purple-100 via-pink-50/30 to-white flex flex-col items-center justify-center px-6">
      ...
      <div className="relative z-10 flex flex-col items-center">
        ...
        <div className="mb-8 relative">
          <div className="w-24 h-24 bg-gradient-to-br from-purple-400 via-pink-400 to-purple-500 rounded-full flex items-center justify-center shadow-2xl shadow-purple-400/50">
        ...
        {/* App Name */}
        <h1 className="text-4xl font-bold text-purple-900 mb-2 tracking-wide">搭搭星球</h1>
