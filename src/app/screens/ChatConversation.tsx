    ...
    <div className="min-h-screen bg-[#1a1a1a] flex flex-col max-w-md mx-auto">
      ...
      <div className="sticky top-0 z-10 bg-[#252525]/95 backdrop-blur-lg border-b border-gray-800/50">
        <div className="flex items-center justify-between h-16 px-4">
          <button
            onClick={() => navigate(-1)}
            className="w-10 h-10 flex items-center justify-center rounded-full hover:bg-gray-700/50 transition-colors -ml-2"
          >
      ...
      {/* Bottom Input Area */}
      <div className="sticky bottom-0 bg-[#252525]/95 backdrop-blur-lg border-t border-gray-800/50 px-4 py-3 safe-area-inset-bottom">
        <div className="flex items-center gap-2.5">
          ...
          <button
            ...
            className="bg-gradient-to-r from-purple-500 to-pink-500 text-white px-5 py-2.5 rounded-lg font-medium text-[15px] hover:from-purple-600 hover:to-pink-600 active:scale-95 transition-all disabled:opacity-40 disabled:cursor-not-allowed disabled:active:scale-100"
          >
            发送
          </button>
        </div>
      ...
      {showMoreMenu && (
        <>
          ...
          />
          <div className="fixed bottom-0 left-0 right-0 z-50 bg-[#2a2a2a]/95 backdrop-blur-lg rounded-t-3xl max-w-md mx-auto animate-in slide-in-from-bottom duration-300 border-t border-gray-800/50">
            <div className="py-4">
              <div className="w-10 h-1 bg-gray-700 rounded-full mx-auto mb-4" />
              <button
                onClick={handleReport}
                className="w-full px-6 py-4 text-white text-base font-medium hover:bg-gray-700/60 transition-colors text-center"
              >
                举报
              </button>
              ...
              <button
                onClick={() => setShowMoreMenu(false)}
                className="w-full px-6 py-4 text-gray-400 text-base hover:bg-gray-700/60 transition-colors text-center"
              >
                取消
              </button>
            </div>
      ...
      <AlertDialog open={showReportDialog} onOpenChange={setShowReportDialog}>
        <AlertDialogContent className="bg-[#2a2a2a]/95 backdrop-blur-lg border-gray-800/50 max-w-sm rounded-2xl">
          <div className="absolute top-4 right-4">
            <button
              onClick={() => setShowReportDialog(false)}
              className="w-9 h-9 flex items-center justify-center rounded-full hover:bg-gray-700/60 transition-colors"
            >
              <X className="w-5 h-5 text-gray-400" />
            </button>
          </div>
          <AlertDialogHeader>
            <AlertDialogTitle className="text-white text-xl font-semibold mb-4">
              举报
            </AlertDialogTitle>
          ...
          <div className="space-y-4">
            <textarea
              ...
              placeholder="请输入举报内容"
              className="w-full h-32 bg-[#1a1a1a] text-white placeholder-gray-500 rounded-xl px-4 py-3 text-[15px] leading-[1.5] outline-none focus:ring-2 focus:ring-purple-500/50 resize-none transition-all border border-gray-700/50"
            />
            <button
              onClick={handleSubmitReport}
              disabled={!reportContent.trim()}
              className="w-full bg-gradient-to-r from-purple-500 to-pink-500 text-white py-3.5 rounded-xl font-semibold text-base hover:from-purple-600 hover:to-pink-600 active:scale-[0.98] transition-all disabled:opacity-40 disabled:cursor-not-allowed disabled:active:scale-100"
            >
              提交
            </button>
          </div>
