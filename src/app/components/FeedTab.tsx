...
export default function FeedTab() {
  ...
  return (
    <div className="flex flex-col h-full">
      {/* Header */}
      <div className="bg-[#1a1a1a] sticky top-0 z-10">
        <div className="px-4 pt-6 pb-3">
          <div className="flex items-center justify-between mb-4">
            ...
            >
              <span
                className={`text-xl font-bold transition-colors ${
                  activeSubTab === "friends" ? "text-white" : "text-gray-500"
                }`}
              >
                嗒伴圈
              </span>
            ...
            >
              <span
                className={`text-xl font-bold transition-colors ${
                  activeSubTab === "public" ? "text-white" : "text-gray-500"
                }`}
              >
                广场
              </span>
            ...
            <button
              onClick={() => navigate("/dark/feed-notifications")}
      ...
      <button
        onClick={() => navigate("/dark/create-feed")}
        className="fixed bottom-24 right-4 w-14 h-14 bg-purple-500 hover:bg-purple-600 text-white rounded-full shadow-lg flex items-center justify-center transition-all hover:scale-110 z-10"
      >
